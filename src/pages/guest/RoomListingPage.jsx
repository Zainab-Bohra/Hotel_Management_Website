...
import { filterRooms } from "../../features/roomSlice";
import RoomCard from "../../components/RoomCard";
import { motion, AnimatePresence } from "framer-motion";

const RoomListingPage = () => {
  const dispatch = useDispatch();
  const { filteredRooms } = useSelector((state) => state.rooms);

  const [filters, setFilters] = useState({
    search: "",
    type: "",
    price: 1000, // Max price
    amenities: [],
  });
          ...
          >
            <AnimatePresence>
              {filteredRooms.length > 0 ? (
                ...
                <p className="text-center font-body col-span-full">
