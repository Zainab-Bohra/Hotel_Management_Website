...
// Variants for the staggered fade-in
const navContainerVariants = {
  hidden: {},
  visible: {
    transition: {
      staggerChildren: 0.1, // Each link will animate 0.1s after the previous one
    },
  },
};
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `relative z-10 block px-4 py-2 font-body font-medium transition-colors ${
                      isActive
                        ? "text-deep-brown" // Active text
                        : "text-deep-brown hover:text-gold" // Inactive text
                    }`
                  }
                >
                  {({ isActive }) => (
